...
/**
 * Servlet implementation class ReporteCursos
 */
public class ReporteInstructores extends HttpServlet {
	String name = null;
	/**
	 * 
	 */
	...
	protected void processRequest(HttpServletRequest request,
		...
		List<CursoDTO> listaCursos = (List<CursoDTO>) session
				.getAttribute("instructuresReporte");
		viewReportPDF(name, response, listaCursos);
	}
	...
	public void viewReportPDF(String name, HttpServletResponse response,
		...
		InputStream ins = UtilReporte.class.getResourceAsStream("ReporteHorasInstructor"
				+ ".jrxml");
		try {
